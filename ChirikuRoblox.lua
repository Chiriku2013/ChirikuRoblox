...
_G.imageLogo = "rbxassetid://119198835819797"
_G.Logo = "rbxassetid://119198835819797"
_G.NameHub = "Made By Chiriku Roblox" -- ชื่อ Hub
_G.Title = "Chiriku Roblox Script Blox Fruits" -- คำอธิบาย
-----------------------------------------------------------------
		...
		function sections:Section(Name,side)
			...
			spawn(function()
			    while wait() do
			        pcall(function()
      			      wait(0.1) 
			            -- Set the color to a single color (e.g., black)
			            game:GetService('TweenService'):Create(
    			            Line, TweenInfo.new(1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut),
 			               {BackgroundColor3 = Color3.fromRGB(0, 255, 0)} -- black color
			            ):Play() 
			            wait(0.5)            
			        end)
			    end
